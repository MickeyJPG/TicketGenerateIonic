  ...
  template: `
    <ion-header>
      <ion-toolbar color="danger">
        <ion-title>Gerenciador de Tickets</ion-title>
      </ion-toolbar>
    </ion-header>

    <ion-content class="ion-padding">
      <ion-button expand="block" color="danger" (click)="emit('SP')">
        Emitir Senha Prioritária (SP)
      </ion-button>

      <ion-button expand="block" color="danger" (click)="emit('SG')">
        Emitir Senha Geral (SG)
      </ion-button>

      <ion-button expand="block" color="danger" (click)="emit('SE')">
